...
### Результат.
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/1.jpg)
## Выводы
Git установлен

## Задание 2
### Настройка
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/2.jpg)
## Выводы
Можно настроить личные данные, редактор, а так же просматривать список настроек с помощью команды git config --list

## Задание 3
### Создание нового репозитория
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/3.jpg)
## Выводы
Для связи между локальным репозиторием и удалённым нужно инициализирвоать репозиторий локально.
  
## Задание 4
### Подготовка файлов
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/4.jpg)
## Выводы
Есть команды для добавления одног офайла и проверки статуса файлов.

## Задание 5
### Фиксация изменений
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/5.1.jpg)
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/5.2.jpg)
## Выводы
...
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/6.1.jpg)
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/6.2.jpg)
## Выводы
...
## Задание 7
### Ветвление
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/7.jpg)
## Выводы
...
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/8.jpg)
## Выводы
...
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/9.jpg)
## Выводы
...
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/10.jpg)
## Выводы
git log / git diff - команды для отслеживания изменений в коммитах

## Задание 11
### Возвращение файла к предыдущему (определенному) состоянию
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/11.jpg)
## Выводы
...
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/12.1.jpg)
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/12.2.jpg)
## Выводы
...
## Задание 13
### Исправление коммита
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/13.jpg)
## Выводы
...
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/14.jpg)
...
## Задание 15
### Настройка .gitignore
![Меню](https://github.com/DimaGolyn/SoftwareEngineeringAIS/blob/main/pic/15.jpg)
## Выводы
